program basic5_built_in_function
    implicit none
    ...
    print "(a14,f3.1)", "SIN(1.5708) = ", SIN(1.5708)       ! trigonometry only work with radian, not degree
    print "(a14,f3.1)", "COS(1.5708) = ", COS(1.5708)
    print "(a14,f3.5)", "TAN(1.5708) = ", TAN(1.5708)
    print "(a10,f3.1)", "ASIN(0) = ", ASIN(0.0)
    print "(a10,f3.1)", "ACOS(0) = ", ACOS(0.0)
    print "(a10,f3.1)", "ATAN(0) = ", ATAN(0.0)
    
    pause
end program basic5_built_in_function
